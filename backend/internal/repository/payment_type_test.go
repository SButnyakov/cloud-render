...
func (r *RepositoryTestSuite) TestPaymentTypeRepository_CreatePaymentType() {
	repo := repository.NewPaymentTypeRepository(r.api.db)
...
func (r *RepositoryTestSuite) TestPaymentTypeRepository_GetTypesMap() {
	repo := repository.NewPaymentTypeRepository(r.api.db)
